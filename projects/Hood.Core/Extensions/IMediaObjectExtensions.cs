        ...
        public static string ToIcon(this IMediaObject mediaObject)
        {
            ...
            switch (mediaObject.GenericFileType)
            {
                ...
                case GenericFileType.Excel:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/excel.png";
                case GenericFileType.PDF:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/pdf.png";
                case GenericFileType.PowerPoint:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/powerpoint.png";
                case GenericFileType.Word:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/word.png";
                case GenericFileType.Photoshop:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/photoshop.png";
                case GenericFileType.Audio:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/audio.png";
                case GenericFileType.Video:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/video.png";
                case GenericFileType.Unknown:
                default:
                    return "https://cdn.jsdelivr.net/npm/hoodcms@4.0.1/images/icons/file.png";
            }
            if (!output.IsSet())
            {
