...
namespace Hood.Services
{
    public interface IAuth0AccountRepository : IAccountRepository<Auth0User, Auth0Role>
    {
        ...
        Task<Auth0Identity> CreateLocalAuthIdentity(
    ...
    public interface IAccountRepository<TUser, TRole> : IHoodAccountRepository
    {
        ...
        Task<UserListModel<UserProfileView<TRole>>> GetUserProfileViewsAsync(
            UserListModel<UserProfileView<TRole>> model
        );
    ...
    public interface IHoodAccountRepository
    {
        ...
        Task<UserListModel> GetUserProfilesAsync(
            UserListModel model,
