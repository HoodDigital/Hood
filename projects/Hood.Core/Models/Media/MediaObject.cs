    ...
    public abstract class MediaBase : BaseEntity, IMediaObject
    {
        ...
        public static string NoImageUrl
        {
            get
            {
                ...
                try
                {
                    ...
                    noImage = mediaSettings.NoImage.IsSet() ? mediaSettings.NoImage : "https://cdn.jsdelivr.net/npm/hoodcms@5.0.0-rc2/images/no-image.jpg";
                }
                catch
                {
                    noImage = "https://cdn.jsdelivr.net/npm/hoodcms@5.0.0-rc2/images/no-image.jpg";
                }
                return noImage;
            }
        }
        ...
        public static IMediaObject BlankAvatar
        {
            get
            {
                ...
                {
                    MediaSettings mediaSettings = Engine.Settings.Media;
                    noImage = mediaSettings.NoImage.IsSet() ? mediaSettings.NoImage : "https://cdn.jsdelivr.net/npm/hoodcms@5.0.0-rc2/images/no-avatar.jpg";
                }
                catch
                {
                    noImage = "https://cdn.jsdelivr.net/npm/hoodcms@5.0.0-rc2/images/no-avatar.jpg";
                }
                MediaObject ret = new MediaObject
                {
                    FileSize = 0,
