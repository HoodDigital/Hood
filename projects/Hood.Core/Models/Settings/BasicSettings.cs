...
namespace Hood.Models
{
    public class BasicSettings : SaveableModel
    {
        ...
        [Display(
            Name = "Homepage",
            Description = "Choose a homepage for the site, other than the default Homepage."
        )]
        public int? Homepage { get; set; }

        [Display(
            Name = "Enable Themes",
            Description = "Enable the use of themes, when enabled, you can choose the site theme from the Settings > Themes page"
        )]
