...
namespace Hood.Models
{
    public class LoginAreaSettings
    {
        ...
        [Display(
            Name = "Area Title",
            Description = "Change the default title for your login areas."
        )]
        public string Title { get; set; }

        [Display(
            Name = "Background Images",
            Description = "Change the background images for your login areas. Enter an image url on each line, these can be local or public URLs."
        )]
