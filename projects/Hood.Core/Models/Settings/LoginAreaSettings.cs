...
namespace Hood.Models
{
    public class LoginAreaSettings
    {
        ...
        {
            Logo = "https://cdn.jsdelivr.net/npm/hoodcms@4.1.1/images/hood-cms.png";
            Title = "Hood CMS";
            BackgroundImages = "";
            for (int i = 1; i <= 9; i++)
            {
                BackgroundImages += $"https://cdn.jsdelivr.net/npm/hoodcms@4.1.1/images/bg/{i}.jpg{Environment.NewLine}";
            }
