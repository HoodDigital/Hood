...
namespace Hood.Models
{
    public class UserProfileView<TRole> : UserProfileBase
    {
        ...
        public List<TRole> Roles
        {
            get
            {
                return !RolesJson.IsSet()
                    ? new List<TRole>()
                    : JsonConvert.DeserializeObject<List<TRole>>(RolesJson);
            }
    ...
    public class UserProfileBase : IUserProfile, IName
    {
        ...
        [Display(
            Name = "Anonymous",
            Description = "If set, user will details will not show up in public areas of the site."
        )]
        ...
        public virtual Address DeliveryAddress
        {
            get
            {
                return DeliveryAddressJson.IsSet()
                    ? JsonConvert.DeserializeObject<Address>(DeliveryAddressJson)
                    : null;
            }
        ...
        public virtual Address BillingAddress
        {
            get
            {
                return BillingAddressJson.IsSet()
                    ? JsonConvert.DeserializeObject<Address>(BillingAddressJson)
                    : null;
            }
        ...
        public virtual IMediaObject Avatar
        {
            get
            {
                return AvatarJson.IsSet()
                    ? JsonConvert.DeserializeObject<MediaObject>(AvatarJson)
                    : MediaObject.BlankAvatar;
            }
        ...
        public virtual Dictionary<string, string> Metadata
        {
            ...
            set
            {
                UserVars = JsonConvert.SerializeObject(
                    value,
                    new JsonSerializerSettings()
                    {
                        ContractResolver = new DefaultContractResolver
        ...
        [Display(
            ...
            Description = "Whether or not you consent to marketing emails."
        )]
        public virtual bool MarketingEmails
        {
            get
            {
                return this[nameof(MarketingEmails)] != null
                    ? JsonConvert.DeserializeObject<bool>(this[nameof(MarketingEmails)])
                    : false;
            }
        ...
        {
            get => this[nameof(WebsiteUrl)];
            set => this[nameof(WebsiteUrl)] = value;
        }
        ...
        {
            get => this[nameof(Twitter)];
            set => this[nameof(Twitter)] = value;
        }
        ...
        public virtual string TwitterHandle
        {
            get => this[nameof(TwitterHandle)];
            set => this[nameof(TwitterHandle)] = value;
        }
        ...
        {
            get => this[nameof(Facebook)];
            set => this[nameof(Facebook)] = value;
        }
        ...
        {
            get => this[nameof(Instagram)];
            set => this[nameof(Instagram)] = value;
        }
        ...
        {
            get => this[nameof(LinkedIn)];
            set => this[nameof(LinkedIn)] = value;
        }
        #endregion
        ...
        {
            get => this[nameof(CompanyName)];
            set => this[nameof(CompanyName)] = value;
        }
        ...
        {
            get => this[nameof(JobTitle)];
            set => this[nameof(JobTitle)] = value;
        }
        #endregion
        ...
        public virtual List<UserNote> Notes
        {
            get
            {
                return this[nameof(Notes)] != null
                    ? JsonConvert.DeserializeObject<List<UserNote>>(this[nameof(Notes)])
                    : new List<UserNote>();
            }
