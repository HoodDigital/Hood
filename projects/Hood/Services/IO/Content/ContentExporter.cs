...
namespace Hood.Services
{
    public class ContentExporter : IContentExporter
    {
        ...
        public ContentExporter(IFTPService ftp, IHostingEnvironment env, IConfiguration config, IMediaManager<SiteMedia> media, ISiteConfiguration site, IEmailSender email)
        {
            _ftp = ftp;
            _config = config;
