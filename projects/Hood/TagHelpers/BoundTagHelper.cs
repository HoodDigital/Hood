...
<div class='{2}'>
    <input data-bind='value: {3}.{4}, events: {{ change: change, keyup: change }}' type='{5}' class='{6}' value='{7}' {8} />
</div>", LabelClass, FieldName, FieldDivClass, Obj, Field, Type, InputClass, Value, Format);
...
<label class='{0}'>{1}</label>
<div class='{2}'>
    <textarea data-bind='value: {3}.{4}, events: {{ change: change, keyup: change }}' type='{5}' class='{6}' value='{7}' {8}></textarea>
</div>", LabelClass, FieldName, FieldDivClass, Obj, Field, Type, InputClass, Value, Format);
                output.Content.AppendHtml(content);
            }
        }
