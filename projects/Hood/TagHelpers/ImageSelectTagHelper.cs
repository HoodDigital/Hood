...
namespace Hood.TagHelpers
{
    ...
    public class ImageSelectTagHelper : TagHelper
    {
            ...
            output.Content.SetHtmlContent($@"
                <div class='row no-gutter align-items-center'>
                    ...
                    <div class='col-auto pl-0'>
                        <button class='btn btn-dark btn-lg hood-image-set' data-target='.{fieldId}' data-restrict='image' type='button'><i class='{ButtonIcon}'></i></button>
                    </div>
                </div>
                {fieldDescription}
            ");
