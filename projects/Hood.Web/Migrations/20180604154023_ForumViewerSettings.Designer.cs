...
namespace Hood.Web.Migrations
{
    ...
    [Migration("20180604154023_ForumViewerSettings")]
    partial class ForumViewerSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hood.Models.Forum", b =>
                {
                    ...
                    b.Property<bool>("PostingRequiresSubscription");

                    b.Property<string>("PostingRoles");

                    b.Property<string>("PostingSubscriptions");

                    b.Property<string>("PostingSusbcriptions");
                    ...
                    b.Property<bool>("ViewingRequiresSubscription");

                    b.Property<string>("ViewingRoles");

                    b.Property<string>("ViewingSubscriptions");

                    b.Property<string>("ViewingSusbcriptions");
            ...
            modelBuilder.Entity("Hood.Models.Subscription", b =>
                {
                    b.HasOne("Hood.Models.Forum")
                        .WithMany("Subscriptions")
                        .HasForeignKey("ForumId");

                    b.HasOne("Hood.Models.Topic")
                        .WithMany("Subscriptions")
                        .HasForeignKey("TopicId");
                });
