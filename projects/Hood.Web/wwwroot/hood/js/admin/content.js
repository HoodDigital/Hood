...
$.hood.Content = {
    Init: function () {
        ...
        if ($('#content-edit-form').doesExist())
            $.hood.Content.Edit.Init();
    ...
    Delete: function (e) {
        ...
        deleteContentCallback = function (isConfirm) {
            if (isConfirm) {
    ...
    SetStatus: function (e) {
        ...
        publishContentCallback = function (isConfirm) {
            if (isConfirm) {
    ...
    Clone: function (e) {
        ...
        duplicateContentCallback = function (isConfirm) {
            if (isConfirm) {
                $.post($tag.attr('href'), $tag.data('status'), function (data) {
                    $.hood.Helpers.ProcessResponse(data);
                    $.hood.Content.Lists.Content.Reload();
        ...
        $.hood.Alerts.Confirm(
            "This will duplicate the content and everything inside it.",
            "Are you sure?",
    ...
    Categories: {
        ...
        Delete: function (e) {
            ...
            deleteCategoryCallback = function (isConfirm) {
                if (isConfirm) {
                    $.post($tag.attr('href'), function (data) {
                        $.hood.Helpers.ProcessResponse(data);
                        $.hood.Content.Lists.Categories.Reload();
