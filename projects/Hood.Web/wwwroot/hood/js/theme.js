...
var demoMode = function () {
    var e, t, a, o, l, n, r, s, c = document.querySelector("#demoForm"), i = document.querySelector("#topnav"), d = document.querySelector("#topbar"), u = document.querySelector("#sidebar"), f = document.querySelector("#sidebarSmall"), p = document.querySelector("#sidebarUser"), b = document.querySelector("#sidebarSmallUser"), h = document.querySelector("#sidebarSizeContainer"), v = document.querySelectorAll('input[name="navPosition"]'), m = document.querySelectorAll('[class^="container"]'), g = (document.querySelectorAll("#stylesheetLight, #stylesheetDark"),
        document.querySelector("#stylesheetLight")), y = document.querySelector("#stylesheetDark"), S = {
    ...
    return function () {
        for (var e = window.location.search.substring(1).split("&"), t = 0; t < e.length; t++) {
            var a = e[t].split("=")
                , o = a[0]
                , l = a[1];
            "colorScheme" != o && "navPosition" != o && "navColor" != o && "sidebarSize" != o || (localStorage.setItem("dashkit" + o.charAt(0).toUpperCase() + o.slice(1), l),
                S[o] = l)
        }
    }(),
        "light" == (e = S.colorScheme) ? (g.disabled = !1,
            y.disabled = !0,
        ...
        t = S.navColor,
        u && f && i && ("default" == t ? (u.classList.add("navbar-light"),
            f.classList.add("navbar-light"),
            i.classList.add("navbar-light")) : "inverted" == t ? (u.classList.add("navbar-dark"),
                f.classList.add("navbar-dark"),
                i.classList.add("navbar-dark")) : "vibrant" == t && (u.classList.add("navbar-dark", "navbar-vibrant"),
        ...
        r = S.navColor,
        s = S.sidebarSize,
        $(o).find('[name="colorScheme"][value="' + l + '"]').closest(".btn").button("toggle"),
        $(o).find('[name="navPosition"][value="' + n + '"]').closest(".btn").button("toggle"),
        $(o).find('[name="navColor"][value="' + r + '"]').closest(".btn").button("toggle"),
        $(o).find('[name="sidebarSize"][value="' + s + '"]').closest(".btn").button("toggle"),
        C(S.navPosition),
            ...
            e.preventDefault(),
                function (e) {
                    ...
                    localStorage.setItem("dashkitColorScheme", t),
                        ...
                        localStorage.setItem("dashkitSidebarSize", l),
...
!function () {
    ...
    function c(e) {
        ...
        !function e(t, a) {
            for (var o in a)
                "object" != typeof a[o] ? t[o] = a[o] : e(t[o], a[o])
        }(a, o),
            (l || n) && function (e, n, r) {
                n = n || "",
                    r = r || "",
                    ...
                    e.options.tooltips.callbacks.label = function (e, t) {
                        var a = t.datasets[e.datasetIndex].label || ""
                            , o = e.yLabel
                            , l = "";
                        return 1 < t.datasets.length && (l += '<span class="popover-body-label mr-auto">' + a + "</span>"),
                            l += '<span class="popover-body-value">' + n + o + r + "</span>"
                    }
            }(a, l, n),
            a.update()
    }
    ...
    "undefined" != typeof Chart && (Chart.defaults.global.responsive = !0,
        ...
        Chart.defaults.global.tooltips.custom = function (l) {
            ...
            if (e || ((e = document.createElement("div")).setAttribute("id", "chart-tooltip"),
        ...
        Chart.defaults.doughnut.legendCallback = function (e) {
            ...
            return o.labels.forEach(function (e, t) {
                ...
                l += '<span class="chart-legend-item">',
                    l += '<i class="chart-legend-indicator" style="background-color: ' + a + '"></i>',
                    l += e,
                    l += "</span>"
            }),
                l
    ...
    function () {
        ...
        "undefined" != typeof Dropzone && e && (Dropzone.autoDiscover = !1,
    ...
    function () {
        var e, t = document.querySelectorAll(".kanban-category"), a = document.querySelectorAll(".kanban-add-link"), o = document.querySelectorAll(".kanban-add-form");
        function l(e) {
            ...
            o.classList.toggle("d-none"),
                ...
                a && a.classList.contains("card-sm") && (a.classList.contains("card-flush") ? a.classList.remove("card-flush") : a.classList.add("card-flush"))
        }
        "undefined" != typeof Draggable && t && (e = t,
    ...
    function () {
        ...
        function l(e) {
            ...
            if (t)
                (a = document.createElement("div")).innerHTML = '<span class="avatar avatar-xs mr-3"><img class="avatar-img rounded-circle" src="' + t + '" alt="' + e.text + '"></span><span>' + e.text + "</span>";
            else
                var a = e.text;
            return a
        }
